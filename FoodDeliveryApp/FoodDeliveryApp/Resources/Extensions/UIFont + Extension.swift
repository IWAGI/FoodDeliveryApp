...
/*
 Ставим принудительное извлечение, так как мы точно знаем, что такие файлы (файлы шрифтов) есть в преокте, потому что мы их добавили. Сомнительно конечно...
 */
extension UIFont {
    enum Roboto {
        enum black {
...
/*
Приватное расширени, которое будет описывать перечисление с названиями наших шрифтов
 */
